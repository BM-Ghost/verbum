...
import com.verbum.feature.bible.data.BibleRepositoryContractImpl
...
abstract class BibleModule {
    ...
    @Binds
    @Singleton
    abstract fun bindBibleRepositoryContract(impl: BibleRepositoryContractImpl): BibleRepositoryContract
}
